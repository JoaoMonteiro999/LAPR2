...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_STORE_MANAGER, new ManagerUI()));
    ...
    private UserRoleDTO selectsRole(List<UserRoleDTO> roles) {
        if (roles.size() == 1) {
            ...
            Utils.showList(rolesString,"Select the role you want to adopt in this session:");
            return (UserRoleDTO) Utils.selectsObject(roles);
        }
    }
